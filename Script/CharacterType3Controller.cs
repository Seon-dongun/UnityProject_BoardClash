...
// 캐릭터 타입3. 원거리 타입 캐릭터 컨트롤러
public class CharacterType3Controller : CharacterController
{
    int attackDamage = 10;

    int[] dx = { 0, 0, 2, -2, -2, -2, 2, 2, -2, 0, 2, 4, 4, 4, -4, -4, -4, -2, 0, 2 };
    int[] dy = { 2, -2, 0, 0, 2, -2, 2, -2, 4, 4, 4, 2, 0, -2, 2, 0, -2, -4, -4, -4 };
